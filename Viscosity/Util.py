...
def load_data():
    ...
    with open('ViscTrainingData.json') as f:
        data = json.load(f)
    for i in data:
        #if mol name contains naphthalene skip in the name
        #if 'naphthalene' in i['MolName']:
            #print('skipping naphthalene')
            #continue
    ...
    return X,FG,T,Y,['CH3','CH','Quaternary_C','Benzyl_Rings','CH2','CH2_Chains','Cyclo_CH2'],idx,Names
