...
# Save Data
np.savetxt('SurfTTrainingData_full.txt', X, delimiter='\t', fmt='%s', header='Name', comments='')
...
data = pd.read_csv('SurfTTrainingData_full.txt', delimiter='\t', names=column_names, skiprows=1)
...
for name,MAPE in zip(data['Name'],data['MAPE']):
    ...
    elif any(prefix in lower_name for prefix in ['iso', 'neo', 'methyl','ethyl','propyl','butyl','pentyl','hexyl','heptyl','octyl','nonyl','decyl','dimethyl','diethyl','dipropyl','dibutyl','dipentyl','dihexyl','diheptyl','dioctyl','dinonyl','didecyl','trimethyl']):
